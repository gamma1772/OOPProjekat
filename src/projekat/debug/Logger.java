 ...
 * */
public class Logger {
	public enum enumLoggerTip {
		INFO, DEBUG, ERROR, MESSAGE, WARNING
	}
	...
	public String poruka(String poruka, int tip) {
		...
		switch (tip) {
			case 0:
				tipPoruke = enumLoggerTip.INFO.name();
				break;
			case 1:
				tipPoruke = enumLoggerTip.DEBUG.name();
				break;
			case 2:
				tipPoruke = enumLoggerTip.ERROR.name();
				break;
			case 3:
				tipPoruke = enumLoggerTip.MESSAGE.name();
				break;
			case 4:
				tipPoruke = enumLoggerTip.WARNING.name();
				break;
			default:
